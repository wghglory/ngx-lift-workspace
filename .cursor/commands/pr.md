     ...
     - **Process**:
       ...
       2. **Analyze Code Changes**:
          ...
          - Check for:
            ...
            - Angular 21 patterns (standalone components, OnPush, signal inputs/outputs, new control flow)
...
2. **Comprehensive Code Analysis**:
   ...
   - Checks for compliance with:
     ...
     - **Angular 21**: Standalone components, OnPush strategy, signal inputs/outputs, new control flow syntax
...
- [ ] ✅ **MANDATORY**: Perform AI code review:
  ...
  - [ ] Analyze code against all standards in `.cursor/rules/` (TypeScript, Angular 21, Clarity, Testing, RxJS, Nx, Accessibility)
